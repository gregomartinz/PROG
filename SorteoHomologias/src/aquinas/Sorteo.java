...
public class Sorteo {
	...
	public void sortear(){
		...
		int tamano = homologosEnSorteo.size();
	...
	public void imprimeResultados(){
		...
		for(Homologia objeto : homologosConHabitacion){		
			...
			System.out.println(contador +"º "+ objeto.toString());
			contador++;
			try {
				Thread.sleep(2000);
			}catch (InterruptedException e) {
