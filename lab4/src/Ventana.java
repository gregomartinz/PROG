 ...
 * Las pantallas t�picas tienen 800x600 pixels (horizontal x vertical).
 * <p/>
 ...
 *
 * @author Jos� A. Ma�as &lt;jmanas@dit.upm.es&gt;
 * @version 4 (3.10.2006)
 */
public class Ventana extends JPanel {
     ...
     *
     * @param ancho n�mero de pixels en horizontal.
     * @param alto  n�mero de pixels en vertical.
     */
     ...
     * @param base   tama�o horizontal del rect�ngulo.
     * @param altura tama�o vertical del rect�ngulo.
     ...
     * Dibuja una elipse.
     *
     * @param nwx    coordenada X del extremo superior izquierdo del rect�ngulo circunscrito a la elipse.
     * @param nwy    coordenada Y del extremo superior izquierdo del rect�ngulo circunscrito a la elipse.
     ...
     * @param x     coordenada X del extremo inferior izquierdo del rect�ngulo circunscrito al texto.
     * @param y     coordenada Y del extremo inferior izquierdo del rect�ngulo circunscrito al texto.
     */
     ...
     * @param x     coordenada X del extremo superior izquierdo del rect�ngulo circunscrito a la imagen.
     * @param y     coordenada Y del extremo superior izquierdo del rect�ngulo circunscrito a la imagen.
