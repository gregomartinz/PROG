...
public class Pruebas {
	...
	public static void main(String[] args) {
		...
		Personas burbujita = new Personas ("Germán Orgueira", 3);
		...
		s15.anadirHomología(competitiva);
		s15.anadirHomología(pabloburbu);
		s15.anadirHomología(as);
		s15.anadirHomología(marca);
