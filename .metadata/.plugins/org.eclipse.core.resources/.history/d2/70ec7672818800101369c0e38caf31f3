...
public class AntenaDireccional implements Ubicado, Radiante {
    ...
    /**
     * Construcci'on de una AntenaDireccional a partir de sus par'ametro.
     ...
     * @param p Nuevo valor de la posici'onn de la antena
     */
    ...
    /**
     * Consulta del valor del 'angulo de la antena.
     * @return Valor actual del 'angulo.
     */
    ...
    /**
     * Asigna un nuevo valor del 'angulo de la antena.
     * @param angulo Nuevo valor del 'angulo.
     */
    ...
    /**
     *<p>Calcula si el punto est'a bajo la cobertura de la antena.</p>
     *
     * @return si est‡ en el 'area de cobertura
    ...
    public boolean enCobertura(Coordenada p) {
        ...
        double anguloDiferencia =
            Math.atan2(diferencia.getY(), diferencia.getX());
    ...
    public String toString() {
        ...
        return  df.format(angulo) + " " + df.format(apertura) + " "
              + df.format(radio) + " "
                + posicion.toString();
    }
